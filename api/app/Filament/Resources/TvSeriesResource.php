...
use App\Filament\Resources\TvSeriesResource\RelationManagers;
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('first_air_date')
                    ->date()
                    ->sortable(),
                Tables\Columns\TextColumn::make('number_of_seasons')
                    ->numeric()
                    ->sortable(),
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('generate')
                    ...
                    ->action(function (TvSeries $record, array $data, AiGenerationTriggerService $service) {
