...
class TvSeriesReportRepository
{
     ...
     * Find report by ID.
     */
    public function findById(string $id): ?TvSeriesReport
    {
        return TvSeriesReport::with(['tvSeries', 'description'])->find($id);
    }
}
