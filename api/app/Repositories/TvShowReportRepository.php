...
class TvShowReportRepository
{
     ...
     * Find report by ID.
     */
    public function findById(string $id): ?TvShowReport
    {
        return TvShowReport::with(['tvShow', 'description'])->find($id);
    }
}
