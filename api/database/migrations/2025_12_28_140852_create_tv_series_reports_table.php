...
return new class extends Migration
{
    ...
    {
        Schema::create('tv_series_reports', function (Blueprint $table) {
            ...
            $table->foreignUuid('description_id')->nullable()->constrained('tv_series_descriptions')->nullOnDelete();
            ...
            $table->index(['tv_series_id', 'status']);
    ...
    {
        Schema::dropIfExists('tv_series_reports');
    }
};
